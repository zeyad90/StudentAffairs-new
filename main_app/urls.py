...
from .hod_views import StudentBulkUploadView,DownloadCSVViewdownloadcsv
...
urlpatterns = [
    ...
    path("attendance/fetch/", views.get_student_attendance,name='get_student_attendance'),
    ...
    path("u", hod_views.process_excel, name='process_excel'),
...
#     path("attendance/update/",hod_views.update_attendance, name='update_attendance'),
...
#     path("staff/attendance/update/",staff_views.update_attendance, name='update_attendance'),
    ...
    path('download/<int:pk>/', student_views.download_attachment, name='download_attachment'),
